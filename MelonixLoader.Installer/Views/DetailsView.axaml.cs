...
public partial class DetailsView : UserControl
{
    ...
    protected override async void OnDataContextChanged(EventArgs e)
    {
        ...
        {
            Model.Offline = true;
            DialogBox.ShowError("Failed to fetch MelonixLoader releases. Ensure you're online.");
        }
    }
    ...
    private async void SelectZipHandler(object sender, TappedEventArgs args)
    {
        ...
        {
            Title = "Select a zipped MelonixLoader version...",
            AllowMultiple = false,
            FileTypeFilter =
            [
                new("ZIP Archive")
